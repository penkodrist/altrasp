...
let ddScreenWrapper = document.querySelector('.ddDateScreenWrapper')
let posX
let posY
let objWidth
...
function innerANF(thisVar) {
    if (thisVar.getAttribute("data-href") !== "subjectsSchedule" && allDayBtns !== null) {
...
for (let i = 0; i < Object.keys(daysArray).length; i++) {
    ...
    dayBtn.addEventListener("click", function () { spaEvent(chgr, this.getAttribute('spa-target')) })
